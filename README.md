...
This is an importer for [beancount](https://github.com/beancount/beancount) (version 3) to convert CSV files exported from the online banking of Volksbank or GLS Bank. 
